...
<template>
  <section class="container-page pt-16 pb-10">
    <div class="max-w-3xl">
      <p class="chip mb-4">Hello — I'm Tomm</p>
      <h1
        class="font-serif text-4xl sm:text-5xl leading-tight tracking-tight"
        :style="{ color: 'var(--color-text)' }"
      >
        在台北的餐桌、街角，<br />與一些不太重要但很重要的小事。
      </h1>
      <p class="mt-5 text-base sm:text-lg text-[var(--color-text-soft)] leading-relaxed">
  ...
  <section class="container-page py-10">
    <header class="flex items-end justify-between mb-5">
      <h2 class="font-serif text-2xl tracking-tight">最新文章</h2>
      <RouterLink
        to="/posts"
  ...
  <section class="container-page py-10">
    <header class="flex items-end justify-between mb-5">
      <h2 class="font-serif text-2xl tracking-tight">餐廳精選</h2>
      <RouterLink
        to="/restaurants"
        class="text-sm text-[var(--color-text-soft)] hover:text-[var(--color-accent)] transition"
      >全部 →</RouterLink>
